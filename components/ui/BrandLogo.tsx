...
export default function BrandLogo({ icon, name }: BrandLogoProps) {
  return (
    <div
      className="flex items-center justify-center p-6 rounded-lg border border-base-200 dark:border-base-800 bg-white dark:bg-base-800 opacity-60 hover:opacity-100 transition-opacity duration-300"
