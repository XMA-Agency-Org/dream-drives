            ...
            <div className="absolute inset-0 overflow-hidden bg-base-50 dark:bg-base-800">
              ...
              >
                ...
                <rect
                  ...
                  height="800"
                  fill="currentColor"
                  className="text-base-100 dark:text-base-900"
                />

                {/* Water - Dubai Creek/Canal */}
                <path
                  d="M200,400 C300,350 400,450 500,400 C600,350 700,400 800,350 C900,300 1000,370 1100,350 L1100,800 L200,800 Z"
                  className="fill-primary-100 dark:fill-primary-900/30"
                />

                {/* Main roads */}
                <path
                  d="M100,350 L1100,350"
                  className="stroke-base-200 dark:stroke-base-700"
                  strokeWidth="15"
                />
                <path
                  d="M100,500 L1100,500"
                  className="stroke-base-200 dark:stroke-base-700"
                  strokeWidth="15"
                />
                <path
                ...
                {/* base roads */}
                <path
                  d="M150,200 L1050,200"
                  className="stroke-base-200 dark:stroke-base-700"
                  strokeWidth="8"
                />
                <path
                  d="M150,650 L1050,650"
                  className="stroke-base-200 dark:stroke-base-700"
                  strokeWidth="8"
                />
                <path
                ...
                <rect
                  ...
                  width="70"
                  height="40"
                  className="fill-base-300 dark:fill-base-600"
                />
                <rect
                  x="420"
                  y="230"
                ...
                <rect
                  ...
                  width="60"
                  height="70"
                  className="fill-primary-100 dark:fill-primary-900/30 stroke-primary-500 dark:stroke-primary-400"
                  strokeWidth="3"
                />
                ...
                <rect
                  ...
                  width="40"
                  height="40"
                  className="fill-primary-200 dark:fill-primary-800/50 stroke-primary-600 dark:stroke-primary-400"
                  strokeWidth="3"
                />
                ...
                <text
                  ...
                  fontSize="12"
                  textAnchor="middle"
                  className="fill-base-600 dark:fill-base-400"
                >
                  Business Bay
                </text>
                <text
                ...
                <polygon
                  points="650,300 670,200 690,300"
                  className="fill-base-400 dark:fill-base-500 stroke-base-500 dark:stroke-base-400"
                  strokeWidth="2"
                />
                <text
                  x="670"
                ...
                <circle
                  ...
                  cy="100"
                  r="30"
                  className="fill-white dark:fill-base-700 stroke-base-400 dark:stroke-base-500"
                  strokeWidth="1"
                />
                <text
                  x="1100"
                ...
                <path
                  d="M1100,70 L1100,90"
                  className="stroke-base-600 dark:stroke-base-400"
                  strokeWidth="2"
                />
                <path
                  d="M1100,110 L1100,130"
                  className="stroke-base-600 dark:stroke-base-400"
                  strokeWidth="2"
                />
                <path
                  d="M1070,100 L1090,100"
                  className="stroke-base-600 dark:stroke-base-400"
                  strokeWidth="2"
                />
                <path
                  d="M1110,100 L1130,100"
                  className="stroke-base-600 dark:stroke-base-400"
                  strokeWidth="2"
                />
              </svg>
              ...
              {/* Business Bay marker */}
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 animate-bounce">
              ...
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[100px] h-[100px] rounded-full bg-primary-500/20 animate-pulse"></div>
            </div>
