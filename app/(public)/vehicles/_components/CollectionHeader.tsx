...
export default function CollectionHeader() {
  return (
    <div className="relative py-16 bg-secondary-50 dark:bg-secondary-900 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-6 z-10 relative">
        <SectionHeader
          ...
          titleClassName="text-secondary-900 dark:text-white"
          descriptionClassName="text-secondary-600 dark:text-secondary-300 text-lg"
        />
      </div>
    </div>
  );
