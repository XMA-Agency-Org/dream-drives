  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
      {brands.map((brand) => (
        <div
          key={brand.name}
          className="flex items-center justify-center p-6 rounded-lg border border-base-200 dark:border-base-800 bg-white dark:bg-base-800 opacity-80 hover:opacity-100 transition-opacity duration-300"
        >
